...
export interface MarginOrder {
     ...
     * @memberof MarginOrder
     */
    contingencyType?: MarginOrderContingencyTypeEnum;
    /**
     * Symbol code.
     * @type {string}
     * @memberof MarginOrder
     ...
     * @memberof MarginOrder
     */
    status: MarginOrderStatusEnum;
    /**
     * Order type.
     * @type {string}
     * @memberof MarginOrder
     */
    type: MarginOrderTypeEnum;
    /**
     ...
     * @memberof MarginOrder
     */
    timeInForce?: MarginOrderTimeInForceEnum;
    /**
     * Order quantity.
     * @type {string}
     * @memberof MarginOrder
...
/**
    ...
    * @enum {string}
    */
export enum MarginOrderContingencyTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export enum MarginOrderSideEnum {
    Sell = 'sell',
    Buy = 'buy'
}
/**
    ...
    * @enum {string}
    */
export enum MarginOrderStatusEnum {
    New = 'new',
    Suspended = 'suspended',
...
/**
    ...
    * @enum {string}
    */
export enum MarginOrderTypeEnum {
    Limit = 'limit',
    Market = 'market',
    StopLimit = 'stopLimit',
...
/**
    ...
    * @enum {string}
    */
export enum MarginOrderTimeInForceEnum {
    GTC = 'GTC',
    IOC = 'IOC',
    FOK = 'FOK',
    Day = 'Day',
